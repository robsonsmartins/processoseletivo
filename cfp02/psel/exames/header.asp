...
<tr valign=top>
		<td align=left>
						<table border=0 cellspacing=20>
							<tr><td><FONT color=#c8cfc7 face=Arial size=4>Processo Seletivo - <i>Acesso Secretaria</i></FONT></td></tr>
						</table>
		</td>
...
<tr><td bgcolor="#273F6F" align=right><font size=1 color=white><b>
<% if (session("tipo_login") = "adm") then%>
<a href="../cadastros/adm.asp">MENU ADMINISTRADOR</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%	end if%>
<a href="default.asp">SELEÇÃO DOS EXAMES</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../login/login.asp">LOGIN</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../secretaria/default.asp">MENU PRINCIPAL</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:window.close()">SAIR DO SISTEMA</a></b>&nbsp;&nbsp;</td></tr>
