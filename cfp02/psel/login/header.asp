...
<tr valign=top>
		<td align=left>
						<table border=0 cellspacing=20>
							<tr><td><FONT color=#c8cfc7 face=Arial size=4>Processo Seletivo - <i>Login do Sistema</i></FONT></td></tr>
						</table>
		</td>
...
<tr><td bgcolor="#273f6f" align=right><a href="login.asp">LOGIN</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:window.close()">SAIR DO SISTEMA</a></td></tr>
