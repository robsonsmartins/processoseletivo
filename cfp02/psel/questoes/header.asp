...
<tr valign=top>
		<td align=left>
						<table border=0 cellspacing=20>
							<tr><td><FONT color=#c8cfc7 face=Arial size=4>Processo Seletivo - <i>Acesso Professor</i></FONT></td></tr>
						</table>
		</td>
...
<%	end if%>
<a href="../login/login.asp">LOGIN</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="disciplinas.asp">SELEÇÃO DE DISCIPLINAS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:window.close()">SAIR DO SISTEMA</a></b>&nbsp;&nbsp;</td></tr>
